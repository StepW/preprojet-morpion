...
//		int n =r.nextInt(Max+1);
		...
		while(Joueurs.getJc() == Joueurs.getJ2() && l[n].getText() == ""){
			...
			if(		bouton1.getText() == Joueurs.getJ2()  //si 3 symboles sont allignés
					&& bouton2.getText() == Joueurs.getJ2()
					&& bouton3.getText() == Joueurs.getJ2()){
			...
			else if(		bouton4.getText() == Joueurs.getJ2()
					&& bouton5.getText() == Joueurs.getJ2()
			...
			else if(		bouton7.getText() == Joueurs.getJ2()
			...
			else if(		bouton1.getText() == Joueurs.getJ2()
					&& bouton4.getText() == Joueurs.getJ2()
			...
			else if( 	bouton2.getText() == Joueurs.getJ2()
					&& bouton5.getText() == Joueurs.getJ2()
					&& bouton8.getText() == Joueurs.getJ2()){
								bouton2.setBackground(Color.cyan);
								bouton5.setBackground(Color.cyan);
			...
			else if( 	bouton3.getText() == Joueurs.getJ2()
					&& bouton6.getText() == Joueurs.getJ2()
					&& bouton9.getText() == Joueurs.getJ2()){
								bouton3.setBackground(Color.cyan);
								bouton6.setBackground(Color.cyan);
		...
		//		int n =r.nextInt(Max+1);
				...
				int n = rand.nextInt(8);
						...
						while(Joueurs.getJc() == Joueurs.getJ2() && l[n].getText() == ""){
							...
							if(	bouton1.getText() == Joueurs.getJ1()  //si 3 symboles sont allignés
									&& bouton2.getText() == Joueurs.getJ1()
									&& bouton3.getText() == "" ){
									 bouton3.setText(Joueurs.getJ2());
								}
							else if(	bouton1.getText() == Joueurs.getJ1()  //si 3 symboles sont allignés
									&& bouton3.getText() == Joueurs.getJ1()
									&& bouton2.getText() == "" ){
									 bouton2.setText(Joueurs.getJ2());
								}
							
							else if(	bouton2.getText() == Joueurs.getJ1()  //si 3 symboles sont allignés
									&& bouton3.getText() == Joueurs.getJ1()
									&& bouton1.getText() == "" ){
									 bouton1.setText(Joueurs.getJ2());
								}
							
							else if(	bouton4.getText() == Joueurs.getJ1()  //si 3 symboles sont allignés
									&& bouton5.getText() == Joueurs.getJ1()
									&& bouton6.getText() == "" ){
									 bouton6.setText(Joueurs.getJ2());
								}
							
							else if(	bouton4.getText() == Joueurs.getJ1()  //si 3 symboles sont allignés
									&& bouton6.getText() == Joueurs.getJ1()
									&& bouton5.getText() == "" ){
									 bouton5.setText(Joueurs.getJ2());
								}
							
							else if(	bouton6.getText() == Joueurs.getJ1()  //si 3 symboles sont allignés
									&& bouton5.getText() == Joueurs.getJ1()
									&& bouton4.getText() == "" ){
									 bouton4.setText(Joueurs.getJ2());
								}
							
							else if(	bouton7.getText() == Joueurs.getJ1()  //si 3 symboles sont allignés
									&& bouton8.getText() == Joueurs.getJ1()
									&& bouton9.getText() == "" ){
									 bouton9.setText(Joueurs.getJ2());
								}
							
							else if(	bouton7.getText() == Joueurs.getJ1()  //si 3 symboles sont allignés
									&& bouton9.getText() == Joueurs.getJ1()
									&& bouton8.getText() == "" ){
									 bouton8.setText(Joueurs.getJ2());
								}
							
							else if(	bouton9.getText() == Joueurs.getJ1()  //si 3 symboles sont allignés
									&& bouton8.getText() == Joueurs.getJ1()
									&& bouton7.getText() == "" ){
									...
									&& bouton4.getText() == Joueurs.getJ1()
									&& bouton7.getText() == "" ){
									 bouton7.setText(Joueurs.getJ2());
								}
							
							else if(	bouton1.getText() == Joueurs.getJ1()  //si 3 symboles sont allignés
									&& bouton7.getText() == Joueurs.getJ1()
									&& bouton4.getText() == "" ){
									 bouton4.setText(Joueurs.getJ2());
								}
							...
							else if(	bouton8.getText() == Joueurs.getJ1()  //si 3 symboles sont allignés
									&& bouton5.getText() == Joueurs.getJ1()
									&& bouton2.getText() == "" ){
									 bouton2.setText(Joueurs.getJ2());
								}
							
							else if(	bouton3.getText() == Joueurs.getJ1()  //si 3 symboles sont allignés
									&& bouton6.getText() == Joueurs.getJ1()
									&& bouton9.getText() == "" ){
									 bouton9.setText(Joueurs.getJ2());
								}
